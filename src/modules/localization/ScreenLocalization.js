...
var ScreenLocalization = cc.Layer.extend({
    ...
    loadGui:function()
    {
        ...
        var btnFrench = gv.commonButton(200, 64, size.width - 120, size.height - 220,"French");
        this.addChild(btnFrench);
        btnFrench.addClickEventListener(this.onSelectEnglish.bind(this));
    ...
    onSelectFrench:function(sender)
    {
        fr.Localization.getInstance().setCurrentLanguage('en');
        this.loadGui();
    },
